...
The main code-base for this project is in R -- please see the `rlookc` package for proper detail. Currently, the Python version only supports loading and assembly of knockoffs that were saved to disk using the R software. 
